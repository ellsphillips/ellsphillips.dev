...
I joined the Civil Service as an Operational Researcher, where I was able to apply mathematics to real-world problems, before diving into the world of Data Science. Shout out to the ONS' Data Science Campus and my fantastic mentors.

Built several ML models to classify large unstructured data into new Government assets, and even worked with Mastercard to generate insights from transactional data throughout the pandemic.
...
A few years later, I now lead several development teams at the Department for Levelling Up, Housing and Communities, developing our spatial data capability by building applications to inform policy with user-centred design and novel data sources.

## Why now?

Good question. Not sure, other than I know I've wanted to do this for quite some time.
